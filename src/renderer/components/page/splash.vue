<template>
  <transition name="slide-left" mode="out-in">
    <div class="router-view splash-page">
      <div class="logo">
      ...
      <div class="open-weather-map">
        ...
        <button @click="open('https://openweathermap.org/?utm_source=weather-bar-app&utm_medium=in-app&utm_campaign=owm-weather-bar')" class="owm-logo">
...
.splash-page {
  ...
  .loading {
    ...
    &:before {
    	transform: scale(1,1);
    	opacity: 1;
    	-webkit-animation: waveB 0.6s infinite linear;
    	animation: waveB 0.6s infinite linear;
    }
    &:after {
    	transform: scale(0,0);
    	opacity: 0;
    	-webkit-animation: waveA 0.6s infinite linear;
    	animation: waveA 0.6s infinite linear;
    }
  }
  .open-weather-map {
    color: rgba(255, 255, 255, 0.5);
